...
if(isset($_POST['update']))
{
    ...
    $query="UPDATE userRegistration SET firstName=?, middleName=?, lastName=?, gender=?, contactNo=?, block=?, roomNo=?, updationDate=? WHERE id=?";
    $stmt = $mysqli->prepare($query);
    $rc=$stmt->bind_param('sssssissi',$fname,$mname,$lname,$gender,$contactno,$block,$roomNo,$udate,$aid);
    $stmt->execute();
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <input type="text" name="block" id="block" class="form-control" required="required" value="<?php echo $row->block;?>">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <input type="text" name="room" id="room" class="form-control" required="required" value="<?php echo $row->roomNo;?>">
    </div>
</div>
